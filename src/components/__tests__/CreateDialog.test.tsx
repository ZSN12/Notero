...
describe('CreateDialog notebook edit mode', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })

  it('initializes input with existing notebook title', () => {
    render(<CreateDialog />)
    expect(screen.getByDisplayValue('Old Notebook Title')).toBeInTheDocument()
    expect(screen.getByText('编辑学科名称')).toBeInTheDocument()
  })
